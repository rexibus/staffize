...
candidate2 = User.create(first_name: "Laura", last_name: "Paselli", role: "candidate", email: "laura@gmail.com", password: "laura@gmail.com",
    language: "Italian, French, German", experience: "4 years as a hostess in a high class restaurant. 3 years as an assistant for special events.", ssn: "444889918", date_of_birth: "21/07/1994", mobile_phone: "+1 216 890 5673", gender: "female")
candidate3 = User.create(first_name: "Cristiano", last_name: "Malgioglio", role: "candidate", email: "cristiano@msn.com", password: "cristiano@msn.com",
    language: "Italian, English", experience: "Host for 10 years.", ssn: "987654321", date_of_birth: "30/12/1988", mobile_phone: "+39 48 29 22 22", gender: "male")
candidate4 = User.create(first_name: "Al", last_name: "Bundy", role: "candidate", email: "al@hotmail.com", password: "al@hotmail.com",
    language: "Italian, French, German", experience: "Promoter for 3 years. Personal assistant to Rihanna for 4 years.", ssn: "444889918", date_of_birth: "21/07/1989", mobile_phone: "+39 02 26 14 22", gender: "male")
candidate5 = User.create(first_name: "Randy", last_name: "Smith", role: "candidate", email: "randtheman@yahoo.com", password: "randtheman@yahoo.com@yahoo.com",
    language: "Italian, English", experience: "10 years in the service industry. Model for 5 years.", ssn: "543390789", date_of_birth: "18/07/1989", mobile_phone: "+39 48 77 88 90", gender: "male")
candidate6 = User.create(first_name: "Anna", last_name: "Tabbi", role: "candidate", email: "tabbianna@gmail.com", password: "tabbianna@gmail.com",
    language: "Italian, French, German", experience: "1 year as a hostess in a high class restaurant. 1 years as a bartender. ", ssn: "444889918", date_of_birth: "21/07/1996", mobile_phone: "+39 02 98 45 38", gender: "female")
candidate7 = User.create(first_name: "Francesca", last_name: "De Niro", role: "candidate", email: "frenchie@gmail.com", password: "frenchie@gmail.com",
    language: "Italian, English", experience: "Event assistant of all kinds for 15 years.", ssn: "987654321", date_of_birth: "06/06/1994", mobile_phone: "+39 48 29 22 22", gender: "female")
...
employer3 = User.create(first_name: "Melissa", last_name: "Cavalli", company_name: "Cavalli Clothes", position: "Temporary HR Manager",
...
event2 = Event.new(title: "2018 Women's Football World Cup Preliminary Match",
    description: "Fooball Competition",
    venue: "San Siro Stadium",
    venue_detail: "Gate 125",
...
event3 = Event.new(title: "Eminem Concert",
  ...
  event4 = Event.new(title: "Le Wagon Demo Day",
    ...
    address: "Corso di Porta Ticinese, 32",
    city: "Milano",
    province: "MI",
    zip_code: "20123",
    country: "Italia",
  ...
  event6 = Event.new(title: "Psychology of Mathematics Educators Conference",
    ...
    start_date: "Tuesday, 24 September 2018",
    end_date: "Tuesday, 27 September 2018",
  ...
  event7 = Event.new(title: "Football Reboot-World Cup With Italy",
    ...
    start_date: "Saturday, 8 September 2018",
    end_date: "Sunday, 7 October 2018",
    address: "Piazzale Angelo Moratti, 1",
    city: "Milano",
    province: "MI",
    zip_code: "20151",
    country: "Italia"
...
job_listing1 = JobListing.new(title: "Event Assistant needed for exciting 2018 Women's Hockey World Cup preliminary match",
 ...
 job_listing2 = JobListing.new(title: "Event Assistant needed for exciting 2018 Women's Hockey World Cup preliminary match",
    category: "Event assistant",
  ...
  job_listing4 = JobListing.new(title: "Event Assistant needed for Le Wagon Demo Day",
    category: "Event assistant",
 ...
 job_listing5 = JobListing.new(title: "Host/Hostess needed for book festival",
  ...
  job_listing6 = JobListing.new(title: "Event Assistant needed for Mathematics Conference",
    category: "Host/Hostess",
...
job_listing7 = JobListing.new(title: "Event Assistant needed for Mathematics Conference",
    category: "Event Assistant",
  ...
  job_listing8 = JobListing.new(title: "Assembly/Dismantling Assistant for exciting sold out Eminem concert",
    ...
    job_listing10 = JobListing.new(title: "Game - Group 2 : Germany - Japan",
    category: "Host/Hostess",
    description: "Seating people and serving wines, beers, long drinks etc. Key to this role is being smiley, proactive and extremely presentable.",
    requirement: "Must be able to serve guests with a smile.",
    schedule_detail: "You will receive 4 x 15 mins breaks.",
    start_date: "Sunday, 9 september 2018",
    end_date: "Sunday, 9 september 2018",
    start_time: "09:00",
    end_time: "20:00",
    gender: "No preference",
    dress_code: "Clean Smart Black T-Shirt/ Black Jeans or Trousers (must have pockets)/ Black trainers or shoes",
    ...
    job_listing11 = JobListing.new(title: "Game - Group 3 : Belgium - Croatia",
    category: "Host/Hostess",
    description: "Seating people and serving wines, beers, long drinks etc. Key to this role is being smiley, proactive and extremely presentable.",
    requirement: "Must be able to serve guests with a smile.",
    schedule_detail: "You will receive 4 x 15 mins breaks.",
    start_date: "Monday, 10 september 2018",
    end_date: "Monday, 10 september 2018",
    start_time: "16:00",
    end_time: "23:30",
    gender: "No preference",
    dress_code: "Clean Smart Black T-Shirt/ Black Jeans or Trousers (must have pockets)/ Black trainers or shoes",
    ...
    job_listing12 = JobListing.new(title: "Game - Group 4 : USA - Cina",
    category: "Host/Hostess",
    description: "Seating people and serving wines, beers, long drinks etc. Key to this role is being smiley, proactive and extremely presentable.",
    requirement: "Must be able to serve guests with a smile.",
    schedule_detail: "You will receive 4 x 15 mins breaks.",
    start_date: "Tuesday, 11 september 2018",
    end_date: "Tuesday, 11 september 2018",
    start_time: "16:00",
    end_time: "23:30",
    gender: "No preference",
    dress_code: "Clean Smart Black T-Shirt/ Black Jeans or Trousers (must have pockets)/ Black trainers or shoes",
...
booking4 = Booking.new(start_date: "Friday, 20 July 2018", end_date: "Friday, 20 July 2018", status: "offered")
booking5 = Booking.new(start_date: "Friday, 21 July 2018", end_date: "Sunday, 23 July 2018", status: "accepted")
...
booking8 = Booking.new(start_date: "Wednesday, 25 July 2018", end_date: "Friday, 27 July 2018", status: "applied")
booking9 = Booking.new(start_date: "Saturday, 8 September 2018", end_date: "Saturday, 8 September 2018", status: "accepted")
booking10 = Booking.new(start_date: "Sunday, 9 September 2018", end_date: "Sunday, 9 September 2018", status: "applied")
booking11 = Booking.new(start_date: "Monday, 10 September 2018", end_date: "Monday, 10 September 2018", status: "offered")
booking12 = Booking.new(start_date: "Tuesday, 11 September 2018", end_date: "Tuesday, 11 September 2018", status: "applied")
booking13 = Booking.new(start_date: "Wednesday, 25 July 2018", end_date: "Friday, 27 July 2018", status: "accepted")
booking14 = Booking.new(start_date: "Friday, 20 July 2018", end_date: "Friday, 20 July 2018", status: "accepted")
booking15 = Booking.new(start_date: "Friday, 21 July 2018", end_date: "Sunday, 23 July 2018", status: "offered")
booking16 = Booking.new(start_date: "Tuesday, 24 July 2018", end_date: "Friday, 27 July 2018", status: "applied")
...
event2.user = employer1
event2.save!
job_listing2.event = event2
job_listing2.save!

event3.user = employer1
event3.save!
...
event7.user = employer1
event7.save!

job_listing9.event = event7
job_listing9.save!
job_listing10.event = event7
job_listing10.save!
job_listing11.event = event7
job_listing11.save!
job_listing12.event = event7
job_listing12.save!
...
booking9.job_listing = job_listing9
booking9.user = candidate2
booking9.save!

booking10.job_listing = job_listing10
booking10.user = candidate2
booking10.save!

booking11.job_listing = job_listing11
booking11.user = candidate2
booking11.save!

booking12.job_listing = job_listing12
booking12.user = candidate2
booking12.save!

booking13.job_listing = job_listing3
booking13.user = candidate2
booking13.save!

booking14.job_listing = job_listing4
booking14.user = candidate2
booking14.save!

booking15.job_listing = job_listing5
booking15.user = candidate2
booking15.save!

booking16.job_listing = job_listing6
booking16.user = candidate2
booking16.save!
